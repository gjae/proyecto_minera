...
<input type="hidden" id="programa" value="diciplinas">
			...
			<div class="body">
				<div class="table-responsive">				
					<table class="table table-bordered table-striped table-hover" id="dataTables-example">
						...
						<tbody>
							@foreach($diciplinas as $key => $diciplina)
								<tr>
									<td>
										{{ $diciplina->created_at->format('d-m-Y') }}
									</td>
									<td>
										{{ $diciplina->codigo_diciplina }}
									</td>
									<td>
	    ...
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	           	<div class="modal-header">
	                <h4 class="modal-title" id="largeModalLabel">Gestion de diciplinas de costo</h4>
	            </div>
