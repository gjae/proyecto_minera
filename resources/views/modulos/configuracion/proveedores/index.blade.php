...
<input type="hidden" id="programa" value="Proveedores">
					...
					<table class="table table-bordered table-striped table-hover" id="dataTables-example">
						<thead>
							<tr>
								...
								<th width="22%">Representante</th>
								<th width="12%">Identificacion</th>
								<th>Acciones</th>
							</tr>
						</thead>
						<tbody>
							@foreach($proveedores as $key => $proveedor)
								<tr>
									...
									<td>{{ $proveedor->nro_identificacion }}</td>
									<td>
										<a role="editar" 
	    ...
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	           	<div class="modal-header">
	                <h4 class="modal-title" id="largeModalLabel">Gestion de proveedores</h4>
	            </div>
