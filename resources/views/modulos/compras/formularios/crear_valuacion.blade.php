					...
					<div class="col-sm-12 col-lg-10 col-md-10">
						<div class="table-responsive">
							<table class="table">
								...
								<tbody>
									@foreach($orden->valuaciones as $key => $valuacion)
										<tr>
									...
									<tr>
										...
										<td></td>
										<td>
											{{ number_format( $orden->valuaciones->sum('monto_valuacion', 2) ) }}
										</td>
									</tr>
									<tr>
										<td> </td>
										...
										<td></td>
										<td>
											<input type="text" id="por_comprometer" class="form-control" readonly value="{{ $orden->total - $orden->valuaciones->sum('monto_valuacion')  }}" name="pendiente_por_valuar">
										</td>
									</tr>
									<tr>
										<td> </td>
